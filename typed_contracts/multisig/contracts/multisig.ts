...
import { ContractAbi } from '../contract-info/multisig';
import QueryMethods from '../query/multisig';
import BuildExtrinsicMethods from '../build-extrinsic/multisig';
import TxSignAndSendMethods from '../tx-sign-and-send/multisig';
import MixedMethods from '../mixed-methods/multisig';
import EventsClass from '../events/multisig';
